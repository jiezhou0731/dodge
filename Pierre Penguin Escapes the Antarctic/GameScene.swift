...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    let initialPlayerPosition = CGPoint(x: 500, y: 500)
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        case PhysicsCategory.enemy.rawValue: break
        
        case PhysicsCategory.coin.rawValue: break
        case PhysicsCategory.powerup.rawValue: break
